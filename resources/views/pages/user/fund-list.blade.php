    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="page-title-box shadow-sm border-0">
                        <h4 class="mb-0 fs-20">
                            <i class="las la-list text-primary me-2"></i>FUND LIST (Sent)
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body">
                    <form method="GET" action="{{ route('user.fund-list') }}">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover align-middle mb-0" id="fundListTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><strong>{{ $transfer->receiver_username }}</strong></td>
                                    <td><span class="badge bg-danger fs-6">-₹{{ number_format($transfer->amount, 2) }}</span></td>
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        <i class="las la-list fs-1 text-muted d-block mb-3"></i>
                                        <h5 class="text-muted">No Transfers Found</h5>
                                        <p class="text-muted mb-0">You haven't sent any funds yet.</p>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
